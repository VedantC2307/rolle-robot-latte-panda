...
class RolleNavigationNode(Node):
    ...
    def __init__(self):
        ...
        # Declare parameters
        self.declare_parameter("map_yaml_path", "/home/vedant/rolle_robot/src/rolle_langchain_agent/rolle_langchain_agent/map/rolle_home_map_1.yaml")
        self.declare_parameter("map_image_path", "/home/vedant/rolle_robot/src/rolle_langchain_agent/rolle_langchain_agent/map/rolle_home_map_1.pgm")
